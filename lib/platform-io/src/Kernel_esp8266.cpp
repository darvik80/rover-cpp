...
#include "net/KernelMulticastFactory.h"
#include "net/JsonMulticastMessage.h"
...
void Kernel::setup() {
    ...
    receiver = multicastFactory().createReceiver("239.255.0.1", 12345);
...
MulticastFactory& Kernel::multicastFactory() {
    return KernelMulticastFactory::instance();
}
