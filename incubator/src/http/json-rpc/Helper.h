...
private:
    std::shared_ptr<Marshaller> _marshaller;
public:
    template<class T>
...
private:
    std::shared_ptr<UnMarshaller> _unMarshaller;
public:
...
class JsonUnMarshaller : public UnMarshaller {                                                      \
    public:                                                                                         \
        explicit JsonUnMarshaller(std::shared_ptr<Owner> obj) : _obj(obj) { }                       \
    private:                                                                                        \
...
#define END_JSON_UNMARSHAL }                                                                    \
    ...
    std::shared_ptr<UnMarshaller> unMarshaller() {                                              \
        return std::make_shared<OwnerUnMarshaller>(shared_from_this());                         \
    }                                                                                           \
...
class JsonMarshaller : public Marshaller  {                                             \
    private:                                                                            \
        const std::shared_ptr<const Owner> _obj;                                        \
    public:                                                                             \
        explicit JsonMarshaller(const std::shared_ptr<const Owner> obj) : _obj(obj) { } \
...
#define END_JSON_MARSHAL return obj;                                                    \
    ...
    std::shared_ptr<Marshaller> marshaller() const {                                    \
        return std::make_shared<OwnerMarshaller>(shared_from_this());                   \
    }                                                                                   \
    virtual tree marshal() const override {                                             \
...
class T : public Marshaller, public UnMarshaller, public std::enable_shared_from_this<T> { \
typedef T Owner;                                                                        \
public:
